...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden pt-36 md:pt-44 pb-24 md:pb-32">
      {/* Background blobs */}
      <div aria-hidden className="absolute inset-0 -z-10">
        <div className="blob -top-32 -left-24 size-[480px] bg-[var(--accent)]/45 animate-float-slow" />
        <div className="blob top-40 right-[-10%] size-[520px] bg-[var(--accent-2)]/35 animate-float-slow" style={{ animationDelay: "2s" }} />
        <div className="blob bottom-[-10%] left-1/3 size-[420px] bg-amber-200/60 animate-float-slow" style={{ animationDelay: "4s" }} />
        <div className="noise" />
      ...
      <div className="container-px mx-auto max-w-7xl">
        <div className="grid items-center gap-14 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7">
            ...
            >
              I&apos;m <span className="text-[var(--primary)] font-medium">Md. Masum Kamal</span> — a graphic designer turning ideas into brand identities, social media creatives, and print work that move people.
            </motion.p>
            ...
            >
              {[
                ...
                <div key={l} className="flex items-center gap-3">
                  <span className="font-display text-2xl font-semibold text-[var(--primary)]">{v}</span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs font-medium text-[var(--primary)]">Typography</span>
      </motion.div>
      <motion.div
        animate={{ y: [0, 10, 0] }}
      ...
      >
        ...
        <span className="text-xs font-medium text-[var(--primary)]">Branding</span>
      </motion.div>
      <motion.div
        animate={{ y: [0, -8, 0] }}
      ...
      >
        ...
        <span className="text-xs font-medium text-[var(--primary)]">Print Design</span>
      </motion.div>
        ...
        <div className="relative z-10 flex h-full flex-col justify-between text-white">
          ...
          <div>
            ...
            <p className="mt-5 max-w-[260px] text-sm text-white/70 leading-relaxed">
              Crafting visual identities that tell a story — bold, intentional, and timeless.
            </p>
          </div>

          <div className="flex items-end justify-between">
            <div className="flex -space-x-1">
              {["#FF6B35", "#2563EB", "#FAF8F5", "#94A3B8"].map((c) => (
                <span
                  key={c}
